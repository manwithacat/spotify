"""
Improved ML Pipeline for Spotify Track Popularity Prediction
...
print("="*80)
print("🎵 IMPROVED ML PIPELINE - SPOTIFY TRACK POPULARITY PREDICTION")
print("="*80)
...
if not os.path.exists(DATA_PATH):
    ...
    print("Please run the EDA notebook (Hackathon2Music.ipynb) first to generate cleaned data.")
    sys.exit(1)
